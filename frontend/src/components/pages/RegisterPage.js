...
export default function RegisterPage({ api }) {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className="text-center mb-3" style={{ color: "#ffeaa7" }}>Register</h3>

        {error && <div className="alert alert-danger py-1">{error}</div>}

        <form onSubmit={handleRegister}>
          <div className="mb-3">
            <label style={{ color: "#dfe6e9" }}>Full Name</label>
            <input
              type="text"
        ...
        <p className="mt-3 text-center" style={{ color: "#dfe6e9" }}>
          ...
          <Link to="/login" style={{ color: "#74b9ff", textDecoration: "none" }}>
            Login
          </Link>
        </p>
      </div>
